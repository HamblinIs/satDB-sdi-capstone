...
class Tracker extends Component {
    ...
    addStations = () => {
        this.addCelestrakSets(this.props);
        //this.engine.addSatellite(ISS);
        //this.addAmsatSets();
    }

    addCelestrakSets = () => {
        const query = this.props.constellation.toString()
        ...
        this.engine.loadLteFileStations(getCorsFreeUrl(`https://celestrak.org/NORAD/elements/gp.php?NAME=${query}`), 0xffffff)
        ...
        //this.engine.loadLteFileStations(getCorsFreeUrl('https://celestrak.org/NORAD/elements/glo-ops.txt'), 0xff0000, { orbitMinutes: 500, satelliteSize: 500 })
            .then(stations => {
                ...
                console.log("this constellation", query)
                console.log("stations", stations)
