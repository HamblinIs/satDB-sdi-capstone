    ...
    try {
      fetch('http://localhost:8080/assessment/new', {
        ...
        body: JSON.stringify({
          ...
          associatedSatTailNum: assessment.associatedSatTailNum,
    ...
    <div>
      ...
      <>
        ...
        <label>Associated Satellite:
          <input type="number" name="associatedSatTailNum" value={assessment.associatedSatTailNum} onChange={handleChange} />
        </label>
        <br/>
        <label>Date:
